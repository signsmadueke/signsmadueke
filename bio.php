...
<section id="bio-hero">
    <div class="image">
        ...
        <img src="assets/images/signs/signs-headshot.jpg" alt="Signs Madueke, Graphic Designer" width="600px" height="auto">
    </div>
    ...
    <div class="text">
        ...
        <div class="body">
            <p>With over four years of experience in the design field, my approach to every project is a blend of strategy and creativity. I’m currently working remotely with the Prayer Publications team in New Jersey, US. See my full work history at <a href="https://linkedin.com/in/signsmadueke" class="btn btn-chevron btn-link">LinkedIn</a>.</p>
            <p>Off the computer, you can find me browsing through TikTok and giggling at memes, rearranging my workspace (yet again), and downing an unhealthy quantity of Coke.</p>
            <p>I take photos on <a href="https://instagram.com/signsmadueke" class="btn btn-chevron btn-link">Instagram</a>, post designs on <a href="https://www.behance.net/signsmadueke" class="btn btn-chevron btn-link">Behance</a>.</p>
            <p>Feel free to connect if you have intriguing ideas to share or just want to be friends.</p>
